...
public class AST {
	...
	public static Branch branch(Expression predicate, Statement ifBranch, Statement elseBranch) {
	...
	public static Operator plus(Expression left, Expression right) {
		return new Operator(Op.ADD, left, right);
	}

	public static Operator minus(Expression left, Expression right) {
		return new Operator(Op.SUBTRACT, left, right);
	}

	public static Operator times(Expression left, Expression right) {
		return new Operator(Op.MULTIPLY, left, right);
	}

	public static Operator dividedBy(Expression left, Expression right) {
		return new Operator(Op.DIVIDE, left, right);
	}
